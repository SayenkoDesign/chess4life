...
<script>
    ...
    var data = {
        ...
        "photos": [
            ...
            ?>
                    {
                        "photo_title": "<?php echo str_replace('"', '\"', get_the_title()); ?>",
                        "address_content": "<?php echo str_replace('"', '\"', get_field('map_address')); ?>",
                        "longitude": <?php the_field('longitude'); ?>,
                        "latitude": <?php the_field('latitude'); ?>,
                        "width": 500,
                        "height": 375,
                        "image_icon": "<?php echo str_replace('"', '\"', get_field('image')); ?>"
                    }
