(function($) {
	var stylish_callbacks = function() {
		...
		$(window).scroll(function() {
				...
				if (scroll > 10) {
					$("header.site-header").removeClass("navbar-static-top navbar-inverse").addClass("navbar-fixed-top navbar-default");
				} else if(scroll < 10) {
					$("header.site-header").removeClass("navbar-fixed-top navbar-default").addClass("navbar-static-top navbar-inverse");
				}
		});
